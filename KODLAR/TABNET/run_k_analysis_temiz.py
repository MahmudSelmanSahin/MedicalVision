"""
TabNet — Adım 3: k Analizi (TEMİZLENMİŞ veri)
Giriş : VERİLER/TEMİZLENMİŞ/YARISMA_TRAIN_{PANEL}_temiz.csv
Çıkış : MODELLER/TabNet/TEMİZLENMİŞ/k_analysis_summary.csv

CatBoost/run_k_analysis.py kalıbının TabNet + TEMİZLENMİŞ uyarlamasıdır.
EMBEDDED skoru = TabNet feature_importances_.
