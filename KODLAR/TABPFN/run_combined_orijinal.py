"""
TabPFN — Özellik Seçimi + Ablasyon Kombinasyonu (ORİJİNAL_VERİ)
...
BEST = {
    "MASTER": ("TabPFN_Ordinal_Encoding_Eksik_Veri_Ortalama",                          "MASTER_tabpfn_ordinal_mean.csv"),
    "KANSER": ("TabPFN_Ordinal_Encoding_Eksik_Veri_Ortalama",                          "KANSER_tabpfn_ordinal_mean.csv"),
    "PAH":    ("TabPFN_Ordinal_Encoding_Eksik_Veri_Ortalama_Yuksek_Eksik_Sutun_Silinmis", "PAH_tabpfn_drop_high_missing_ordinal_mean.csv"),
    "CFTR":   ("TabPFN_Ordinal_Encoding_Eksik_Veri_Medyan",                            "CFTR_tabpfn_ordinal_median.csv"),
}
