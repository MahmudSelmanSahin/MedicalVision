"""
SVM — Özellik Seçimi (ORİJİNAL 353-sütun veri)  [TAM OPTİMİZASYON]
Giriş : MODELLER/SVM/ABLASYON/SVM_best_by_panel.csv
        + VERİLER/ABLASYON_MODEL_BAZLI/{scenario}/{PANEL}_*.csv
Çıkış : MODELLER/SVM/ORİJİNAL_VERİ/{YÖNTEM}/SONUCLAR|GRAFIKLER
