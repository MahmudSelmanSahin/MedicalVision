"""
KNN — k Analizi (ORİJİNAL 353-sütun veri)  [TAM OPTİMİZASYON]
Giriş : MODELLER/KNN/ABLASYON/KNN_best_by_panel.csv
        + VERİLER/ABLASYON_MODEL_BAZLI/{scenario}/{PANEL}_*.csv
Çıkış : MODELLER/KNN/ORİJİNAL_VERİ/ABLASYON/k_analysis_summary.csv
            ...
            for method in ALL_METHODS:
                ...
                try:
                    (y_te, y_pred, y_prob, n_tr, n_te,
                     best_thr, mcc_def, mcc_t05, mcc_topt) = fit_knn_compare(
