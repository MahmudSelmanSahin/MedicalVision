"""
CatBoost — k Analizi (TEMİZLENMİŞ veri)
Giriş : VERİLER/TEMİZLENMİŞ/YARISMA_TRAIN_{PANEL}_temiz.csv
Çıkış : MODELLER/CatBoost/TEMİZLENMİŞ/ABLASYON/k_analysis_summary.csv
...
def main() -> None:
    ...
    for panel, df in panel_dfs.items():
        ...
        panel_cache[panel] = {"df": df, "y": y, "names": names, "scores": scores}
