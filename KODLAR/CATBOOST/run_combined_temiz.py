"""
CatBoost — Özellik Seçimi + Ablasyon Kombinasyonu (TEMİZLENMİŞ)

Her panel için:
  - En iyi ablasyon senaryosu CSV'si (ön-işlenmiş veri) yüklenir
  - Üzerinde özellik seçimi uygulanır (FILTER/WRAPPER/EMBEDDED)
  - Seçilen özelliklerle CatBoost eğitilir
  - Sonuçlar: sadece ablasyon, sadece FS, kombinasyon karşılaştırması
...
# Panel başına en iyi ablasyon senaryosu klasörü ve dosya adı
BEST = {
    "MASTER": ("CATBOOST_Kategorik_String_Eksik_Veri_Korundu",  "MASTER_catboost_none.csv"),
    "KANSER": ("CATBOOST_Kategorik_String_Eksik_Veri_KNNImputer", "KANSER_catboost_knn.csv"),
    "PAH":    ("CATBOOST_Kategorik_String_AL_Sifir_EK_Medyan",  "PAH_catboost_al_zero.csv"),
    "CFTR":   ("CATBOOST_Kategorik_String_AL_Sifir_EK_Medyan",  "CFTR_catboost_al_zero.csv"),
}
...
def main():
    ...
    # ── Panel başına özellik seçimi (bir kez) ────────────────────────────
    panel_cache = {}
    ...
    if all_rows:
        ...
        print(f"✓ En iyi: {OUT_DIR}/{MODEL_NAME}_combined_best_by_panel.csv")
