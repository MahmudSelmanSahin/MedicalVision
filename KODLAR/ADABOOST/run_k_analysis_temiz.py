"""
AdaBoost — k Analizi (TEMİZLENMİŞ veri)  [TAM OPTİMİZASYON]
Giriş : VERİLER/TEMİZLENMİŞ/YARISMA_TRAIN_{PANEL}_temiz.csv
Çıkış : MODELLER/ADABOOST/TEMİZLENMİŞ/ABLASYON/k_analysis_summary.csv
            ...
            for method in ALL_METHODS:
                ...
                try:
                    (y_te, y_pred, y_prob, n_tr, n_te,
                     best_thr, mcc_def05, mcc_t05, mcc_topt) = fit_ada_compare(
